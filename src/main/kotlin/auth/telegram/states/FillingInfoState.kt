...
data class WriteProfessionalDescriptionState(
    ...
    fun next(professionalDescription: String) =
        ChooseQuestionAreasState(phoneNumber, course, name, city, profession, organizationType, organization, professionalDescription)
}
...
data class ChooseQuestionAreasState(
    ...
    fun next() = AddAccountInfoToDataBaseState(
        phoneNumber, course, name, city, profession, organizationType, organization, professionalDescription,
        questionAreas
    )
}
